          ...
          <div class="">
            ...
            >
                  ...
                  <div>
                    ...
                    <div class="flex gap-6">
                      <label class="flex items-center">
                        ...
                        value="Laki-laki"
                        {{ (old('jenis_kelamin', $karyawan->jenis_kelamin ?? '') === 'Laki-laki') ? 'checked' : '' }}
                        required class="w-4 h-4 text-primary-600 focus:ring-2
                      ...
                      <label class="flex items-center">
                        <input type="radio" name="jenis_kelamin"
                        value="Perempuan"
                        {{ (old('jenis_kelamin', $karyawan->jenis_kelamin ?? '') === 'Perempuan') ? 'checked' : '' }}
                        required class="w-4 h-4 text-primary-600 focus:ring-2
                        focus:ring-primary-500" />
              ...
              <div class="col-span-2 flex items-center gap-2">
                <input id="is_active" name="is_active" type="checkbox" {{ $karyawan->is_active ?
                'checked' : '' }} />
                <label
                  for="is_active"
              ...
              <a href="{{ route('karyawan.change_password',$karyawan->user->id) }}" class="block px-3 py-2 text-sm rounded-md text-white bg-black font-medium w-fit">Ganti Password</a>
